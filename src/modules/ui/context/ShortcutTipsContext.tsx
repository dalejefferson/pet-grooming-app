  ...
  return (
    <ShortcutTipsContext.Provider value={{ dismissTip }}>
      ...
      {currentTip && (
        ...
        >
          <div className="flex flex-col gap-2 rounded-xl border-2 border-[#1e293b] bg-[#d1fae5] px-4 py-3 shadow-[3px_3px_0px_0px_#1e293b] min-w-[280px]">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <svg className="h-4 w-4 text-[#1e293b]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
                <span className="text-xs font-semibold text-[#1e293b] uppercase tracking-wide">Quick Tip</span>
              </div>
              <button
                onClick={dismissTip}
            ...
            <div className="flex items-center gap-3">
              <span className="inline-flex items-center rounded-lg border-2 border-[#1e293b] bg-white px-2 py-1 text-sm font-semibold text-[#1e293b] shadow-[1px_1px_0px_0px_#1e293b]">
                {currentTip.keys}
              </span>
              <span className="text-sm text-[#334155]">{currentTip.description}</span>
            </div>
          </div>
        </div>
      )}
