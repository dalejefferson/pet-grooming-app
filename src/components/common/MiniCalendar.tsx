          ...
          return (
            <button
              ...
              className={cn(
                ...
                isCurrentMonth && !isSelected && !inWeekRange && 'text-[#334155] hover:bg-[#f0fdf4]',
                // Today indicator
                dayIsToday && !isSelected && 'border-2 border-primary-400',
                // Selected day (for day view)
                isSelected &&
                  'border-2 border-[#1e293b] bg-primary-500 text-white shadow-[2px_2px_0px_0px_#1e293b]',
